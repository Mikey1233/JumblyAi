    ...
    // <div className="fixed w-full bottom-0 z-50  dark:bg-gray-900">
      ...
      <Form {...form}>
        <form
          ...
          className="flex bg-white space-x-2 p-2 rounded-t-xl max-w-4xl mx-auto bg-whitte border dark:bg-slate-800"
        >
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex-1 ">
                <FormControl>
                  <Input
                    className="border-none bg-white dark:placeholder:text-white/70"
